    ...
    async findEpisodes(id: string): Promise<EpisodeDetails[]> {
        try {
            ...
            while (true) {
                ...
                const episodesUrl = `${this.apiBaseUrl}/api/v1/stream/episodes?id=${mediaId}&provider=${PROVIDER_NAME}&limit=${limit}&offset=${offset}&timestamp=${encodeURIComponent(timestamp)}`
